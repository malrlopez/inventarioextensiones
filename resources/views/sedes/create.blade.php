...
@section('title', 'Crear Sede - Sistema de Inventario')
        ...
        <div class="card-body">
            ...
            <form action="{{ route('sedes.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nombre_sede') is-invalid @enderror" id="nombre_sede" name="nombre_sede" value="{{ old('nombre_sede') }}" required>
                    @error('nombre_sede')
