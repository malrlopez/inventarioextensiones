...
@section('title', 'Crear Empleado - Sistema de Inventario')
            ...
            <form action="{{ route('empleados.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('codigo_marcacion') is-invalid @enderror" id="codigo_marcacion" name="codigo_marcacion" value="{{ old('codigo_marcacion') }}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('numero_cedula') is-invalid @enderror" id="numero_cedula" name="numero_cedula" value="{{ old('numero_cedula') }}" required>
                        @error('numero_cedula')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
