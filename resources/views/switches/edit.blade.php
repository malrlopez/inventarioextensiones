...
@section('title', 'Editar Switch - Sistema de Inventario')
        ...
        <div class="card-body">
            ...
            <form action="{{ route('switches.update', $switch->id_switch) }}" method="POST">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    <a href="{{ route('switches.index') }}" class="btn btn-outline-secondary">Cancelar</a>
                    <button type="submit" class="btn btn-primary">Actualizar Switch</button>
                </div>
            </form>
        </div>
    </div>
